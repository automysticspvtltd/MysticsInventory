...
export const CreateTeamUserBody = zod.object({
  username: zod
    .string()
    .min(createTeamUserBodyUsernameMin)
    .max(createTeamUserBodyUsernameMax),
  email: zod.string(),
  name: zod.string(),
...
export const ListSalesChannelDefaultsResponse = zod.array(
  ListSalesChannelDefaultsResponseItem,
);
